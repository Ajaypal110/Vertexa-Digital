        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          ...
          >
            ...
            <div className="relative z-10 p-2 premium-card overflow-hidden !bg-white">
              ...
              />
              <div className="absolute bottom-10 right-10 bg-white/90 backdrop-blur-xl border border-black/5 p-6 rounded-3xl shadow-2xl">
                <p className="text-3xl font-black text-dark leading-none">5+</p>
          ...
          >
            <div className="space-y-4">
              <span className="text-primary text-xs font-black uppercase tracking-[0.3em] bg-primary/5 px-4 py-2 rounded-full border border-primary/10">Our Story</span>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-dark leading-tight">
            ...
            <div className="grid grid-cols-2 gap-8 pt-4">
              <div>
                <h4 className="text-dark font-black text-lg mb-2">Philosophy</h4>
              ...
              <div>
                <h4 className="text-dark font-black text-lg mb-2">Excellence</h4>
            ...
            <div className="pt-6">
              <h4 className="text-dark/40 font-bold uppercase tracking-widest text-xs mb-6">Expertise Stack</h4>
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <motion.span
                    key={index}
                    whileHover={{ scale: 1.05, borderColor: 'var(--color-primary)' }}
                    className="px-5 py-2.5 rounded-xl bg-primary/5 border border-primary/10 text-primary font-bold text-sm transition-all cursor-default"
                  >
                    {skill}
                  </motion.span>
                ))}
